...
<h2 class="text-center" style="margin-top:100px; margin-bottom:50px;">상품 수정</h2>


<div class="container">
<form role="form" action="./item_modify.php" onsubmit="return postForm()" method="post" enctype='multipart/form-data'>
    ...
    <select name='category'>
        ...
        if($row['category'] == 001){
            ...
            echo "
            <option value='001' >국/찌개/탕</option>
            <option value='002' selected>마른반찬</option>
            <option value='003'>무침</option>
            <option value='004'>볶음</option>
            <option value='005'>조림</option>
            <option value='006'>전/생선</option>
            <option value='007'>김치/절임/젓갈</option>
            ";
        } else if ($row['category'] == 003){
            echo "
            <option value='001' >국/찌개/탕</option>
            <option value='002'>마른반찬</option>
            <option value='003' selected>무침</option>
            <option value='004'>볶음</option>
            <option value='005'>조림</option>
            <option value='006'>전/생선</option>
            <option value='007'>김치/절임/젓갈</option>
            ";
        } else if ($row['category'] == 004){
            echo "
            <option value='001' >국/찌개/탕</option>
            <option value='002'>마른반찬</option>
            <option value='003'>무침</option>
            <option value='004' selected>볶음</option>
            <option value='005'>조림</option>
            <option value='006'>전/생선</option>
            <option value='007'>김치/절임/젓갈</option>
            ";
        } else if ($row['category'] == 005){
            echo "
            <option value='001' >국/찌개/탕</option>
            <option value='002'>마른반찬</option>
            <option value='003'>무침</option>
            <option value='004'>볶음</option>
            <option value='005' selected>조림</option>
            <option value='006'>전/생선</option>
            <option value='007'>김치/절임/젓갈</option>
            ";
            ...
            <option value='004'>볶음</option>
            <option value='005'>조림</option>
            <option value='006' selected>전/생선</option>
            <option value='007'>김치/절임/젓갈</option>
            ";
        } else if ($row['category'] == 007){
            echo "
            <option value='001' >국/찌개/탕</option>
            <option value='002'>마른반찬</option>
            <option value='003'>무침</option>
            ...
            <option value='005'>조림</option>
            <option value='006'>전/생선</option>
            <option value='007' selected>김치/절임/젓갈</option>
            ";
        }
        ?>
        <!-- <option value='001' selected>국/찌개/탕</option>
  ...
  <div class="form-group">
    <label>설명</label>
    <input type="text" name="subtitle" class="form-control" value="<?php echo $row['subtitle']; ?>">
  </div>
  ...
  <div class="form-group">
    ...
    <p><textarea name="rawmaterials" placeholder="원재료 및 함량"  rows="5" cols="150" ><?php echo $row['raw_materials']; ?></textarea></p>
  </div>
  ...
  <div class="form-group" id="htmlimg">
    ...
    <!-- 선택한 이미지 미리보기 -->
    <br><label>수정할 이미지</label><br>
    <img id="blah" src=""  style="max-weight:200px; max-height:200px;"/>
  </div>

    <div class="form-group">
    <label>전에 등록한 이미지</label><br>
    <img src=<?php echo $row['imgpath']; ?>  style="max-weight:200px; max-height:200px;"/>
    <input type="hidden"  name="ex_img" value=<?php echo $row['imgpath']; ?>>
    </div>
  ...
  <div class="form-group">
    ...
    <textarea id="summernote" name="contents"><?php echo $row['contents']; ?></textarea>
