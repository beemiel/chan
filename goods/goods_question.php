...
<h3 class="text-center"  style="margin-top:80px; margin-bottom:50px;">문의 작성</h3>
...
<div class="container">
<form role="form" action="./goods_question_save.php" onsubmit="return postForm()" method="post">
...
<label >문의 분류</label>
<br>
<input type="radio" name="category" value="상품" checked="checked"/> 상품
<input type="radio" name="category" value="배송" /> 배송
<input type="radio" name="category" value="반품/취소" /> 반품/취소
<input type="radio" name="category" value="교환/변경" /> 교환/변경
<input type="radio" name="category" value="기타" /> 기타
  ...
  <div class="form-group">
    ...
    <label>
        <input type="checkbox" name="secret_check" value="secret">비밀글 체크
    </label>
